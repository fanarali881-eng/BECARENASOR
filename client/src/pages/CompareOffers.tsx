    ...
    <div className="min-h-screen bg-gray-50" dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div className="px-3 md:px-16 lg:px-28 pt-6 md:pt-8" dir="rtl">
        <div className="flex items-center justify-center mb-2">
          ...
          <div className="flex flex-col items-center" style={{ minWidth: '80px' }}>
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg" style={{ backgroundColor: '#f5a623' }}>2</div>
            <span className="text-xs mt-2 text-center font-bold" style={{ color: '#f5a623' }}>تفاصيل وثيقة التأمين</span>
          </div>
          {/* Line 2-3 (orange - completed) */}
          <div className="flex-1 h-1 mx-1" style={{ backgroundColor: '#f5a623', marginBottom: '20px' }}></div>
          {/* Step 3 - current (blue circle, blue text) */}
          <div className="flex flex-col items-center" style={{ minWidth: '80px' }}>
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg" style={{ backgroundColor: '#1a5276' }}>3</div>
            <span className="text-xs mt-2 text-center font-bold" style={{ color: '#1a5276' }}>الشركات والعروض</span>
          </div>
