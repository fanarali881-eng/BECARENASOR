  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden" dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <section className="relative" style={{ backgroundColor: primaryBlue, minHeight: '460px', overflow: 'visible' }}>
        ...
        <img src="/images/bcare/LeftBackground.svg" alt="" className="absolute left-0 top-0 pointer-events-none z-[1]" style={{ height: '140%', opacity: 0.4 }} />
        <img src="/images/bcare/RightBackground.svg" alt="" className="absolute right-0 top-0 pointer-events-none z-[1]" style={{ height: '140%', opacity: 0.4 }} />
